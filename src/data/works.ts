...
const items = [
...

  {
    ...
    avatarFallback: 'T T',
    title: 'BugSnap',
    context: 'Bug tracking and management system',
    tech: ['fastapi', 'Next js', 'SQLite'],
    icon: '',
    description:
      'A lightweight and easy-to-use bug tracking and management system designed for small development teams. It simplifies bug reporting, tracking, and resolution.',
    liveLink: '',
    githubLink: '',
    disabled: true,
  },
